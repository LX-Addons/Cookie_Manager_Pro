...
describe("CookieEditor", () => {
  it("should not render when isOpen is false", () => {
    ...
    expect(screen.queryByText("新建 Cookie")).not.toBeInTheDocument();
  });
  ...
  it("should render new cookie editor when cookie is null", () => {
    ...
    expect(screen.getByText("新建 Cookie")).toBeInTheDocument();
  });
  ...
  it("should render edit cookie editor with existing cookie", () => {
    ...
    expect(screen.getByText("编辑 Cookie")).toBeInTheDocument();
